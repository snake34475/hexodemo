...
navbar:
  ...
  logo: # choose [img] or [icon + title]
    img: //rew00265f.hb-bkt.clouddn.com/image/2022/07/12/wu_1g7odq5bbut1kh16a61qbd8mi6.png
    icon: //rew00265f.hb-bkt.clouddn.com/image/2022/07/12/wu_1g7odlq2p6f7ekq170u1msu8g56.png
    title:
  menu:
    - name: 博客
...
cover:
  ...
  logo: http://rew00265f.hb-bkt.clouddn.com/image/2022/07/12/wu_1g7oeutcd1lb5u27133fgtqd579.png  #http://rew00265f.hb-bkt.clouddn.com/image/2022/07/12/wu_1g7o7jj1s2kiu6613vvedo1cob6.jpeg
...
article:
  ...
  body:
    ...
    meta_library:
      ...
      # 文章字数和阅读时长
      wordcount:
        icon_wordcount: fa-solid fa-keyboard PETERRIVE
        icon_duration: fa-solid fa-hourglass-half BELIZEHOLE
      # 文章标签
      tags:
...
comments:
  ...
  artalk:
    ...
    # server: https://tengyao-nextjs.vercel.app/    # 修改为自建的后端服务地址
    path:  # 全局评论地址
    placeholder: # 评论占位
  ...
  waline:
    ...
    placeholder: 各位观众快来评论吧 # 评论占位提示
    serverURL: https://waline-test-xi.vercel.app  #https://tengyao-nextjs.vercel.app #https://tengyao-nextjs.vercel.app # Waline 的服务端地址（必填） 测试用地址: https://waline.vercel.app
    imageUploader:
      # 以兰空图床为例，下列填写内容为：
      # url: https://xxxxxx/api/v1/upload
      # token: Bearer xxxxxxxxxxxxxx
...
sidebar:
  ...
  widget_library:
    ...
    blogger:
      ...
      avatar: http://rew00265f.hb-bkt.clouddn.com/image/2022/07/12/wu_1g7olejcc86jlq4nlb1qeeg2n6.jpeg #volantis-static/media/org.volantis/blog/Logo-NavBar@3x.png # https://cdn.jsdelivr.net/gh/volantis-x/cdn-org/blog/Logo-NavBar@3x.png
      ...
      social:
        ...
        - icon: fab fa-github
          url: https://github.com/snake34475/
